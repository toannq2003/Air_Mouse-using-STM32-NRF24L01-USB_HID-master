...
void CS_Select(){
	HAL_GPIO_WritePin(CSN_PORT, CSN_PIN, (GPIO_PinState)0);
}

void CS_UnSelect(){
	HAL_GPIO_WritePin(CSN_PORT, CSN_PIN, (GPIO_PinState)1);
}

void CE_Enable(){
	HAL_GPIO_WritePin(CE_PORT, CE_PIN, (GPIO_PinState)1);
}

void CE_Disable(){
	HAL_GPIO_WritePin(CE_PORT, CE_PIN, (GPIO_PinState)0);
}
